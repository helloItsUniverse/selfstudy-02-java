...
//        Rabbit rabbit1 = new Animal();
         ...
         *  런타임 당시 실제 객체가 가진 오버라이딩 된메소드로 바인딩이 바뀌어 동작하는 것을 의미한다.
         *  (동적 바인딩의 조건: 1-상속, 2-오버라이딩)
        * */
        System.out.println("동적 바인딩 확인 =======================");
//        an1.cry();        // 이 줄 실행 전에는 이게 동물은 동물인데 어떤 동물인지 모름. 정적 바인딩 상태.
                            // an1.bite(); 에서 bite(); 를 인식하지 못함을 볼 수 있다.
                            // 런타임 시점에 자식의 오버라이딩된 메소드를 찾아서 그 자식의 오버라이딩된게 있으면 그것을 실행하는 것이 동적 바인딩
        an1.cry();
        an2.cry();
        an3.cry();
        ...
        * */
        ...
        Animal animal2 = new Tiger();       // 자동형변환(auto up-casting), 다형성 O, 묵시적형변환
