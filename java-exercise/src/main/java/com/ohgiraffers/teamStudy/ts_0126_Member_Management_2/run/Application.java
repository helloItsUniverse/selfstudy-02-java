package com.ohgiraffers.teamStudy.ts_0126_Member_Management_2.run;
...
import com.ohgiraffers.teamStudy.ts_0126_Member_Management_2.repository.MemberRepository;
import com.ohgiraffers.teamStudy.ts_0126_Member_Management_2.service.MemberService;
        ...
        while (true) {
            ...
            switch (input) {
                ...
                case 7: mm.searchMemberByHobby(chooseHobby());
                    break;
                case 8: mm.resetPassword(findIdOrPw());
                    break;
                case 9:
