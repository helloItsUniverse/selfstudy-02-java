package com.ohgiraffers.teamStudy.ts_0126_Member_Management.repository;


import com.ohgiraffers.teamStudy.ts_0126_Member_Management.aggregate.BloodType;
import com.ohgiraffers.teamStudy.ts_0126_Member_Management.aggregate.Member;
import com.ohgiraffers.teamStudy.ts_0126_Member_Management.stream.MyObjectOutput;
...
public class MemberRepository {
    ...
    private final String filePathName = "C:\\lecture_git\\java-exercise\\src\\main\\java\\com\\ohgiraffers\\teamStudy\\ts_0126_Member_Management\\db\\memberDB.dat";
...
//        }
    ...
    public int findPWD(Member member) {
        ...
        for (Member m : memberList) {
            if (m.getId().equals(member.getId()) && Arrays.equals(m.getHobbies(), member.getHobbies())) {
