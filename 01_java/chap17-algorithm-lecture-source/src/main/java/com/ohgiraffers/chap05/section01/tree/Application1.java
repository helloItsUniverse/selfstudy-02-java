...
public class Application1 {
    ...
    public static String solution(String input) throws IOException {
        ...
        /* 설명. node의 번호와 index의 번호를 일치시키기 위해서 (입력받은 node 크기) + 1 로 설정 */
    ...
    public static void dfs(int parentNode) {
        ...
        /* 설명. 이미 방문한 노드들은 부모 노드들이고 부모 노드들을 재방문하지 않도록 함(방문 배열의 의미) */
        isVisit[parentNode] = true;

        /* 설명. 입력받은 값을 통해 생성된 list로부터 관련있는 노드들을 확인하기 위한 반복문 */
