...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 필기.
         *  Properties란?
         *   HashMap과 거의 유사하지만 jey와 value 모두를 String으로만 사용할 수 있는 자료구조이다.
         *   주로 설정 파일 관련된 파일과의 입출력에 사용된ㄷ.(store, load 등)
        * */
        ...
        /* 설명. 일반 Map보다 파일 입출력에 좀 더 특화되어 있음 */
        ...
        /* 설명. 저장한 파일에서부터 일어온 데이터를 담을 Properties 객체 */
