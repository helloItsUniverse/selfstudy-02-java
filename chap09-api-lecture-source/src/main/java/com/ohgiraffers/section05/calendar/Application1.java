...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 설명. long 타입 시간은 1970/1/1 09:00 KST 부터 지금까지 흐른 밀리초 단위 시간 */
        ...
        System.out.println("todatFormat = " + todayFormat);

        /* 설명. java.util.Date -> java.sql.Date */
        java.sql.Date sqlDate = new java.sql.Date(today.getTime()); // java.util.Date를 long형으로 변환 sql.Date
//        java.sql.Date sqlDate2 = (java.sql.Date)today;            // 실제로는 sql.Date형이었던 날짜형이 util.Date형인 today에 담겨 있었다면 이 방법도 가능하다.
