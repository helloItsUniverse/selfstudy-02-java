...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 설명. Calendar 자료형은 생성자를 통해 객체를 생성할 수 없다. (Singleton) */
        ...
        int year = 1997;
        int month = 9;      // 입력하고자 하는 월 -1 : 모든 프로그래밍 언어가 month 를 내부적으로 0~11 로 처리한다.
        int dayOfMonth = 10;
        int hour = 17;
        int min = 30;
        int second = 0;
        ...
        System.out.println("태어난 월: " + (birthDay.get(Calendar.MONTH) + 1));  // get(Calendar.MONTH) 메소드로 반환반은 값에  +1을 해줘야 우리가 생각하는 월의 개념이 된다.
        ...
        System.out.println("hourOfDay: " + birthDay.get(Calendar.HOUR_OF_DAY));     // 24시간제
