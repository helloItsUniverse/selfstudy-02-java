...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 필기
         *  - String 객체는 리터럴로 생성댈 때 heap 영역의 상수풀(constant pool)에 생성된다.
         *  - 상수풀은 동등한 String 객체를 하나만 저장하는(중복 제거) 공간으로
         *    동일한 String 변수를 효율적으로 사용할 수 있도록 제공된다.
         *    (String의 equals()와 hashCode()를 통해 적용)
        * */

        /* 설명. 위의 4가지 경우 모두 동등한 String 객체이므로 equals()는 true, hashCode()는 같은 값이 나온다. */
        ...
        /* 필기.
         *  String은 불변객체이다.(immutable class)
        * */
        String str = "apple";
        str += ", banana";
