...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 필기.
         *  charAt(): 해당 문자열의 특정 인덱스에 해당하는 문자를 반환한다.(인덱스 체계: 0부터 시작)
        * */
        String str1 = "apple";
        ...
        * */
        ...
        /* 필기.
         *  concat(): 문자열의 인자로 전달된 문자열을 합쳐서 새로운 문자열 반환
        * */
        ...
        /* 필기.
         *  indexOf(): 문자열에서 특정 문자를 탐색하여 처음 일치하는 익덴스 위치를 정수형으로 반환한다.
        * */
