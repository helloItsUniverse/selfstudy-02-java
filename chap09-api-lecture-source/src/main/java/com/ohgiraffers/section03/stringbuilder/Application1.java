...
public class Application1 {
    public static void main(String[] args) {
         ...
         *  StringBuffer: thread save 기능이 추가적으로 동작함.(상대적으로 성능이 안좋음)
        * */
...
//        StringBuilder sb2 = "java";     // StringBuilder는 문자열을 다루지만 리터럴은 다루지 않음
        ...
        for (int i = 0; i < 5; i++) {
             ...
             *  - 따라서 System.identityHashCode() 메소드를 활용해
             *    String으로 관리되는 문자열과 StringBuilder로 관리되는 문자열이
             *    각각 변화를 줄 때 새로운 객체를 생성하는지 살펴보자.
            * */
