...
public class Application2 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            System.out.println("hasnCode: " + System.identityHashCode(sb));
        }
        ...
        * */
//        System.out.println("delete(): " + sb2.delete(2, 5));                // 출력: jaariaDB
//        System.out.println("deleteCharAt(): " + sb2.deleteCharAt(0));       // 출력: aariaDB
