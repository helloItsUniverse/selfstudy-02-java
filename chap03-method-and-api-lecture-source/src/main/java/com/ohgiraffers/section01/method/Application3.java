...
public class Application3 {
    ...
    * */
    ...
    static int global = 10;                     // 전역변수이자 클래스 변수(static 안붙으면 메소드 안에서 에러남)

    public static void main(String[] args) {

        int global = 20;                        // 지역변수
        System.out.println("global 출력 = " + global);
        System.out.println("global 출력 = " + Application3.global);       // 클래스명.변수명 을 하면 클래스 변수를 호출할 수 있다.

        Application3 app3 = new Application3(); // 10 은 전달인자(argument)
        app3.testMethod(10);
        app3.testMethod(19);
//        app3.testMethod(19, 20);              // argument 개수가 안맞아서 에러
    ...
    public void testMethod(int age) {           // int age 는 전달인자를 받는 지역변수이자 매개변수(parameter)
