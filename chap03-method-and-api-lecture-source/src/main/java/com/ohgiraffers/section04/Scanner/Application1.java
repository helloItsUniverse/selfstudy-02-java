...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        String name1 = sc.next();                       // 공백이나 개행 이전까지의 문자열만 반환
        ...
        char answer = sc.nextLine().charAt(0);          // 메소드 체이닝 방식으로 사용자의 입력값에서 인덱스 번째의 문자를 char형으로 반환
        // sc.nextLine().charAt(0): String의 0번째 인덱스의 글자를 char로 바꿔서 반환.
