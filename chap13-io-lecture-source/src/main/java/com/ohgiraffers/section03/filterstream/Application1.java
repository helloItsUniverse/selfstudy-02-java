...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 설명. BufferedReader를 활용해 한 줄씩 출력하기 */
        BufferedWriter bw = null;
        try {
            bw = new BufferedWriter(new FileWriter("src/main/java/com/ohgiraffers/" +
                    "section03/filterstream/testBuffered.txt", true));  // append 옵션: 이어쓰기
             ...
             *
             * 필기.
             *  stream을 close()하면 내부적으로 flush를 호출하긴 함.
            * */
            bw.flush();
