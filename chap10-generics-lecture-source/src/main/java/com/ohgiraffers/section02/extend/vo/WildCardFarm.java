...
public class WildCardFarm {
    ...
    /* 설명. Bunny 제네릭의 농장만 가능 */
    public void extendsType(RabbitFarm<? extends Bunny> farm) {
        farm.getAnimal().cry();
    }

    /* 설명. RabbitFarm 중에서도 Bunny의 상위 타입이 있는 RabbitFarm만 가능 */
    /* 설명. Bunny이거나 Rabbit 제네릭의 농장만 가능 */
