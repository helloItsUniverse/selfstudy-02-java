...
public class Application {
    public static void main(String[] args) {
         ...
         *  하지만 단순히 물려받아 재사용하는 개념보다 부모 클래스의 개념을 확장(Extends) 하는 데 더 의의가 있다.
         ...
         * 필기.
         *  상속의 단점
         *   1. 부모 클래스의 기능을 추가/변경할 시 자식 클래스가 정상적으로 작동하게 되리 예측이 힘들다.
         ...
         * 필기.
         *  메소드 오버라이딩이란?
         *   - 메소드를 재정의(Overriding)하는 것으로 부모 메소드의 헤드부를 그대로 사용하면서
         *     자식 클래스가 정의한 메소드대로 동작하도록 메소드 바디부(몸체)를 새롭게 다시 작성하는 것이다.
         *   - 이후 다형성을 적용하면 자식의 오버라이딩 된 메소드가 우선적으로 동작하게 된다.(동적 바인딩)
         *
         * 필기.
         *  장점과 단점을 고려했을 때, 상속은 오용의 가능성이 있기 때문에
