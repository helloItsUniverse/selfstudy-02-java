...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        Computer computer2 = new Computer("Qualcomm Snapdragon", 1024, 16, "Android");
        System.out.println(computer2);

        Computer computer3 = new Computer("S-01234", "구글", "픽셀", 1000000, new java.util.Date(), "Qualcomm Snapdragon", 2048, 16, "Android");
