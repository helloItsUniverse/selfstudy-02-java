...
public class AssertJTests {
    ...
    /* 목차. 3. 날짜 테스트하기 */
    /* 필기. 날짜 객체가 가지는 년, 월, 일, 시, 분, 초, 밀리초, 나노초까지도 검증이 가능하며,
        특정 날짜 범위, 이전, 이후 내용도 검증 가능하다. */
    ...
    /* 목차. 4. 예외 테스트하기 */
    /* 필기. 예외 내용을 검증하는 것 또한 예외 타입, 예외 메시지 등을 검증할 수 있다. */
    @Test
    @DisplayName("에외 테스트하기")
    ...
    /* 목차. 6. 객체 프로퍼티 검증하기 */
    /* 필기. 객체의 프로프티를 추출하여 filter를 할 수 있다. 이 때 getter함수가 존재하지 않아도 프로퍼티 필터링이 가능하다. */
    @Test
    @DisplayName("객체의 프로퍼티 검증하기")
