...
public class JupiterAssertionsTests {
    ...
    public void testAssertEquals() {
        ...
        /* 설명. 3. then */
//        Assertions.assertEquals(expected, result);      // 단정문
//        Assertions.assertEquals(expected, result, 1);      // 단정문
        Assertions.assertEquals(expected, result, "이건 정확해야 해!!");      // 단정문
    }
    ...
    /* 목차. 7. assertThrows */
    @Test
    @DisplayName("void 메소드의 경우 exception 리 발생하는지 테스트")
