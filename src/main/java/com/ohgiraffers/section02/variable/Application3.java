...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        /* 목차. 1-1. 동일한 범위(같은 중괄호) 내에서 동일한 변수명을 가질 수 없다. */
        int age = 20;
//        int age = 30;
        age = 30;
...
//        int for = 2;
        ...
        int aGe = 20;       // 위에서 초기화한 age와 다른 변수로 최근

        /* 목차. 1-4. 변수명을 숫자로 시작할 수 없다.*/
//        int 1age = 20;
        int age1 = 20;

        /* 목차. 1-5. 변수명에 사용가능한 특수기호로는 '_'와 '$' 이다. */
        int _age = 20;
        int $harp = 10;
//        int #harp = 11;
        ...
        /* 목차. 2. 컴파일 에러를 발생시키지는 않지만 개발자들간의 암뮥적인 규칙(관례상 규칙) */
        /* 목차. 2-1. 변수명의 길이 제한은 없다. 하지만 적당히 하자. */
        int kjjdhluefhafkjzbdlciuahiufhawlehrwq;

        /* 목차. 2-2. 변수명이 합성어로 이루어진 경우 첫 단어는 소문자, 두 번째 시작 단어는 대문자로 시작한다. */
        int maxAge = 50;        // 낙타봉 표기법 (camel case)
        int minAge = 10;

        /* 목차. 2-3. 한글로 변수명을 짓는 것은 가능하지만, 권항하지 않는다. */
        int 나이 = 19;
