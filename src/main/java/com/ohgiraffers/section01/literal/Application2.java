...
//        System.out.println(579);          // 123 + 456 = 579
...
//        System.out.println("hello" % "world");
        ...
        /* 필기. 자바 내무의 컴파일러가 다른 모든 형태의 값들을 문자열로 바꿔버림 */
        ...
        /* 설명. 이항연산자들의 묶음에서 죄측에서부터 이항씩 연산하면 아래 코드의 결과를 이해할 수 있다. */
        System.out.println(123 + 3 + "helloworld" + 123 + 3);
        /* 필기. 컴퓨터 프로그래밍은 '순차적'으로 진행됨.
         *  123(정수) + 3(정수) = 126(정수)
         *  126(정수) + helloworld(문자열) = 126helloworld(문자열)
         *  126helloworld(문자열) + 123(정수) = 126helloworld123(문자열)
         *  126helloworld123(문자열) + 3(정수) = 126helloworld1233(문자열)
        */

        /* 설명. 문자열 뒤에 숫자를 활용한 연산을 쓰게 되면 소괄호()를 써서 우선순위를 높이고 연산해 주어야 한다. */
        System.out.println("합계: " + (123 + 345));
