...
public class Application {
    public static void main(String[] args) {
        ...
        * */
         ...
         *   2.  메소드의 전달인자로 전달할 값이 너무 많아 회원과 관련된 기능을 호출할 때 매개변수가 많아진다. (나쁜 냄새가 남)
         *   3. 메소드의 반환형으로 회원이라는 개념을 반환할 수 없다.(메소드의 반환형은 하나여야 하기 때문에)
        * */

        Member member = new Member();       // 이것도 참조 자료형. 배열과 비슷하지만 클래스의 칸에는 인덱스가 아닌 이름이 달린다.
        Member member2 = new Member();      // 객체 2개를 만든 것.
        ...
        /* 설명. 회원정보를 하나의 전달인자로 전달하고 하나의 매개변수로 받을 수 있다. */
