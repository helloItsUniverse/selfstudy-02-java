...
/* 필기.
 *  자바 빈(Java Bean) 이란?
 *   JSP에서배우게 될 표준 액션 태그로 접근할 수 있게 만든 자바 클래스이다.
 *   자바 코드를 모르는 웹 퍼블리셔들도 자바 코드를 사용할 수 있도록 태그 형식으로 지원하는 문법을 읨하는데,
 *   그 때 사용할 수 있도촉 규칙을 지정해 놓은 java 클래스를 자바빈(java bean)이라고 부른다.
